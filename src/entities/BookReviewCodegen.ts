...
export interface BookReviewFields {
  ...
  reviewer: { kind: "m2o"; type: Reviewer; nullable: never };
}
...
export interface BookReviewFilter {
  ...
  reviewer?: EntityFilter<Reviewer, ReviewerId, FilterOf<Reviewer>, never>;
}
...
export interface BookReviewGraphQLFilter {
  ...
  reviewer?: EntityGraphQLFilter<Reviewer, ReviewerId, GraphQLFilterOf<Reviewer>, never>;
}
...
bookReviewConfig.addRule(newRequiredRule("reviewer"));
...
export abstract class BookReviewCodegen extends BaseEntity<EntityManager> {
  ...
  readonly reviewer: ManyToOneReference<BookReview, Reviewer, never> = hasOne(reviewerMeta, "reviewer", "bookReviews");
